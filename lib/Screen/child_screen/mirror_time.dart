...
class MirrorTime extends StatefulWidget {
  const MirrorTime({super.key});

  @override
  State<MirrorTime> createState() => _MirrorTimeState();
}

class _MirrorTimeState extends State<MirrorTime> {
  int currentStep = 0;
  @override

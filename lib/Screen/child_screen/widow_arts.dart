...
class WindoeArts extends StatefulWidget {
  const WindoeArts({super.key});

  @override
  State<WindoeArts> createState() => _WindoeArtsState();
}

class _WindoeArtsState extends State<WindoeArts> {
  int currentStep = 0;
  @override
